...
// dataup=data;
//Filter by Rating
function filterRating(val,products){
    const filteredByRating = products.filter(product => product.rating >= val);
  ...
  let filteredProducts="none";
  
  ratingFilter.addEventListener('change', updateProductList);
  ...
  function updateProductList() {
    ...
    if (selectedRating !== 'all') {
      filteredProducts = filteredProducts.filter(product => product.rating.rate >= parseInt(selectedRating));
    }
  ...
  updateProductList();
  function sortinp(){
    let flag=document.getElementById('sort-view').value;
    if(filteredProducts!="none"){
        let arr=filteredProducts.sort(
            (a, b) => {
                        if(flag==="increasing"){
...
function filterCategory(){
    ...
    console.log(val);
    console.log(products);
    arr = products.filter(product => product.category === val);
...
//     let flag=document.getElementById('rat');
//     let products=data;
